define("appkit/adapters/application", ["exports"], function(a) {
    "use strict";
    a["default"] = DS.FixtureAdapter.extend()
}), define("appkit/app", ["ember/resolver", "exports"], function(a, b) {
    "use strict";
    var c = a["default"],
        d = Ember.Application.extend({
    ...
    b["default"] = d
}), define("appkit/components/pretty-color", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.Component.extend({
...
}), define("appkit/components/template-less", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.Component.extend({
        classNames: ["look-ma-no-template"],
        tagName: ["span"]
    })
}), define("appkit/controllers/application", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.ArrayController.extend({
        rootNav: function() {
            return this.get("model").filter(function(a) {
                return null === a.get("parent") && a.get("hidden") !== !0
            })
        }.property("model.@each")
    })
}), define("appkit/controllers/index", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.Controller.extend({})
}), define("appkit/controllers/listed-page", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.ObjectController.extend({
        needs: ["page"],
        isSelected: function() {
            return this.get("content").get("root") === this.get("controllers.page").get("root")
        }.property("content.id", "controllers.page.id")
    })
}), define("appkit/controllers/page", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.ObjectController.extend({
...
}), define("appkit/models/page", ["exports"], function(a) {
    "use strict";
    var b = DS.Model.extend({
        ...
        path: function() {
            var a = this.get("parent"),
                b = "";
            return null !== a && (b += a.get("path") + "/"), b + this.get("id")
        }.property("id"),
        navImage: function() {
...
}), define("appkit/router", ["exports"], function(a) {
    "use strict";
    var b = Ember.Router.extend();
    b.map(function() {
        this.route("page", {
            path: "/:page_id"
        })
    }), a["default"] = b
}), define("appkit/routes/application", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.Route.extend({
        model: function() {
            return this.store.find("page")
        }
    })
}), define("appkit/routes/component-test", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.Route.extend({
        model: function() {
...
}), define("appkit/routes/helper-test", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.Route.extend({
        model: function() {
            return {
...
}), define("appkit/routes/index", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.Route.extend({
        isHomepage: function() {
            return !1
...
}), define("appkit/routes/page", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.Route.extend({
        model: function(a) {
            return this.store.find("page", a.page_id)
        }
    })
}), define("appkit/utils/ajax", ["exports"], function(a) {
    "use strict";
    a["default"] = function() {
        return ic.ajax.apply(null, arguments)
    }
}), define("appkit/views/application", ["exports"], function(a) {
    "use strict";
    a["default"] = Ember.View.reopen({
        didInsertElement: function() {
            this._super(), $(".rollover").each(function() {
                var a = $(this),
                    b = a.data("rollover"),
                    c = a.data("default");
                a.hover(function() {
            ...
            }).addClass("cycle-init"), $(".accordions").not(".accordions-init").each(function() {
                var a = $(this),
                    b = a.find(".accordion--question");
                b.on("click", function() {
...
}), define("appkit/templates/about-us", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('<div id="main">\n  <img src="images/banners/aboutus.jpg" width="522" height="142" alt="Aboutus" class="banner" />\n\n  <h1>About Us</h1>\n\n  <p>Personnel Placement Consultancies Pty Ltd (PPC) has been providing vocational solutions for people with injury, illness or disability in the workplace, and their employers, since 1997. We have specialised in providing Workplace Rehabilitation and Disability Employment Services over the past 20 years and have assisted many injured workers and people with a disability or illness to find and maintain employment. We have serviced all Adelaide metropolitan locations, regional SA areas, and also in the ACT.</p>\n\n <p>Our current core business is performing specialised workplace assessments for the National Panel of Assessors, providing recommendations to assist people with a disability to access support in the workplace to maintain meaningful employment.  Our National Panel of Assessors have formal qualifications in Social Work, Behavioural Science (Psychology), Rehabilitation Counselling and Human Resources. Our assessors each have minimum 10 years of experience working within Disability Employment Services, Workplace Rehabilitation, Case Management, Workplace Assessing and Injury Management roles. Our expertise are varied and highly responsive, and our service is adaptable to meet a range of needs. Our clients and referring customers value our professionalism, broad experience and significant capability.</p>\n\n\n</div>')
    })
}), define("appkit/templates/about-us/commitment-to-quality", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('<div id="main">\n  <img src="images/banners/aboutus.jpg" width="522" height="142" alt="Aboutus" class="banner" />\n\n  <h1>Commitment to Quality</h1>\n\n  <p>PPC commits to delivering the highest standard of service and products to our clients and customers.  Our management system has been certified to International ISO 9001:2015 and the National Standards for Disability Services.  PPC also meets the conditions of approval of the Heads of Workers Compensation Authorities. </p>\n  <p>We integrate our quality systems to support optimal service, track performance and outcomes for further improvement, and engage with our staff, clients and customers to ensure our service is effective and responsive, and to promote innovation.</p>\n  <p>We are extremely proud of our ongoing commitment to and achievements in quality.</p>\n\n<div class="quote"><p><strong>Testimonials</strong></p><blockquote>PPC have helped me in so many ways and now I have a great job. They keep in contact with me and have organised modifications to my desk so that it’s easier. I have increased in confidence so much and I love my work. My PPC Consultant gave 110% of her time and gave me the tools to regain my confidence. I am more open minded about employment and they helped me greatly to overcome the barriers I HAD!. I couldn’t fault the service. As a matter of fact they went beyond my expectations.</blockquote></div></div>')
    })
}), define("appkit/templates/about-us/how-can-we-help-you", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/about-us/our-customers", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('<div id="main">\n  <img src="images/banners/aboutus.jpg" width="522" height="142" alt="Aboutus" class="banner" />\n\n  <h1>Our Customers</h1>\n\n  <p>\n    <strong>We understand disability, illness and injury</strong>\n  </p>\n\n  <p>PPC Consultants have supported clients into employment or back to work who are experiencing: physical injury, psychological distress, mental illness, pain disorder, sensory impairment, degenerative conditions, acquired and traumatic brain injury, intellectual disability, autism spectrum disorders and others.  </p>\n\n  <p>We can assist where injuries have been sustained at work or outside work, and with temporary incapacity, permanent injury, lifelong and degenerative conditions.</p>\n\n  <p>PPC Consultants appreciate the impacts of being unwell and the value of meaningful work on people’s families, finances, social activities and general health.  We also know that suitable work can help with these challenges.  PPC works with the whole person to provide strategies to to achieve real outcomes.</p>\n\n<p>\n    <strong>We understand work</strong>\n  </p>\n\n  <p>Our Consultants communicate with employers and visit workplaces every day.  </p>\n  <p>We understand what employers want in their employees, and their expectations for workplace behaviours.  We keep abreast of changing labour markets and appreciate employers’ business needs and pressures.  We understand workplace safety and workers compensation rights and responsibilities for both the employer and employee.</p>\n\n</div>')
    })
}), define("appkit/templates/about-us/our-people", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n            \n    <h1>Our People</h1>\n\n    <p>PPC commits to recruiting, training and retaining the best Consultants and Assessors. PPC are serious about making a difference for our clients and customers, and have specialist skills and commitment to achieve real outcomes.</p>\n    <p>We invest in our people to build their expertise and keep them on board.  In a challenging work arena, where staff turnover is typically high, PPC is proud of the tenure of our staff, and our reputation as an employer of choice.  Our team is versatile, compassionate and committed.</p>\n\n</div><!-- end main -->')
    })
}), define("appkit/templates/about-us/our-people/careers", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/about-us/our-people/management", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('<div id="main">\n <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner"/>\n \n <h1>Management</h1>\n\n <p>PPC’s senior management team has extensive experience in job placement, disability, injury management and workplace rehabilitation and assessment services.</p>\n\n <hr class="rule"/>\n\n <p>\n <strong>Steve Harrington</strong> <br/>\n Managing Director, Bachelor of Social Work <br/>\n E: <a href="mailto:Steve.Harrington@ppcons.com.au">Steve.Harrington@ppcons.com.au</a>\n </p>\n\n <p>Steve established PPC in 1997 and has guided the company from a small team of consultants to becoming one of South Australia’s largest private providers of disability employment, workplace rehabilitation and assessment services. Steve’s previous experience includes working as a Regional Manager, Senior Advisor and Senior Rehabilitation Consultant for the Commonwealth Rehabilitation Service. </p>\n\n <p>\n <strong>Accreditations</strong> <br/>\n Registered Workplace Rehabilitation Consultant with WorkCover SA <br/>\n Comcare Approved Workplace Rehabilitation Provider <br/>\n Member AASW <br/>\n Full Member, Australian Society of Rehabilitation Counsellors\n </p>\n\n <hr class="rule" />\n<p><strong>Tracey Warke</strong> <br/>\n General Manager, Graduate Diploma in Rehabilitation Counselling <br/>\n E: <a href="mailto:Tracey.Warke@ppcons.com.au">Tracey.Warke@ppcons.com.au</a>\n </p>\n\n <p>Tracey has been a valued member of the PPC Management Team since 2003 with managing the Disability Employment Services contract and has been with PPC for over 15 years. Tracey has qualifications in Rehabilitation Counselling and Human Resources – Training and Development and Assessment. She has a wealth of technical expertise and knowledge of all aspects of the delivery and performance of our DES and NPA contracts. Tracey has been responsible for our successful working relationship with the Department of Social Services and other government and non-government departments.</p>\n\n <p>\n <strong>Accreditations</strong> <br/>\n Full Member, Australian Society of Rehabilitation Counsellors <br/>\n Accredited NPA Assessor \n </p>\n\n <hr class="rule" /><p><strong>Cheryl Andrews-Cooper</strong> <br/>\n Contract Manager - NPA, Bachelor of Social Work  <br/>\n E: <a href="mailto:Cheryl.Andrews-Cooper@ppcons.com.au">Cheryl.Andrews-Cooper@ppcons.com.au</a>\n </p>\n\n <p>Cheryl is a qualified Social Worker with an impressive career within Disability Employment Services and counselling. Cheryl has specialised in delivering Job Capacity Assessments Ongoing Support Assessments and Supported Wage System assessments over the past 11 years with PPC and has an excellent knowledge of the NPA contract. Cheryl has provided invaluable support and recommendations to achieve successful return to work outcomes for disabled workers and their employers.</p>\n\n <p>\n <strong>Accreditations</strong> <br/>\n Full Member, Australian Association of Social Workers <br/>\n Accredited NPA Assessor \n </p>\n\n</div>')
    })
}), define("appkit/templates/about-us/our-people/our-team", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n\n    <h1>Our Team</h1>\n\n    <p>PPC NPA Assessors are all tertiary qualified in Human Services and have considerably more than the required minimum two years’ experience, plus a broad knowledge of injury management and disability.</p>\n\n    <p>PPC offers challenging and rewarding career opportunities and a work environment that allows everyone to perform at their best with access to professional support.  The qualities we value in our employees include:</p>\n\n    <ul>\n      <li>A commitment to making a difference for people with injury, illness or disability</li>\n      <li>Professionalism</li>\n      <li>A focus on achieving outcomes for our clients and customers</li>\n      <li>Integrity and respect</li>\n      <li>Self-direction and team support</li>\n      <li>Humility and a commitment to lifelong learning</li>\n    </ul>\n\n    <p>We employ professionals with qualifications in the following fields:</p>\n\n    <ul>\n      <li>Rehabilitation Counselling</li>\n      <li>Psychology</li>\n      <li>Social Work</li>\n      <li>Nursing</li>\n      <li>Occupational Therapy</li>\n      <li>Physiotherapy</li>\n      <li>Disability</li>\n      <li>Employment Services</li>\n    </ul>\n\n    <p>People who work for PPC enjoy:</p>\n\n    <ul>\n      <li>A great work environment, supportive colleagues and management</li>\n      <li>Exposure to a variety of assessment work for broad skill development</li>\n   <li>Flexible working arrangements that balance work and family life</li>\n    </ul>\n\n    <p>For more information, contact us or email <a href="mailto:contactus@ppcons.com.au">contactus@ppcons.com.au</a>.  Any information you forward to us is safe guarded in compliance with our Privacy Policy and the Privacy Act, 1988.  PPC is an Equal Opportunity Employer and our worksites are free from discrimination and harassment.  We welcome applications from people of all ages and backgrounds, and from people with disability.</p>\n    \n    <hr />\n</div><!-- end main -->')
    })
}), define("appkit/templates/about-us/our-values", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/application", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            var d, e, f, h = "";
            return b.buffer.push("\n              <li>\n                "), e = c["link-to"] || a && a["link-to"], f = {
                ...
                types: ["STRING", "ID"],
                data: b
            }, d = e ? e.call(a, "page", "", f) : C.call(a, "link-to", "page", "", f), (d || 0 === d) && b.buffer.push(d), b.buffer.push("\n              </li>\n            "), h
        }

        function g(a, b) {
            var d, e = "";
            return b.buffer.push("\n                  "), d = c["if"].call(a, "isSelected", {
                hash: {},
                hashTypes: {},
                hashContexts: {},
                inverse: B.program(5, i, b),
                fn: B.program(3, h, b),
                contexts: [a],
                types: ["ID"],
                data: b
        ...
        function h(a, b) {
            var d = "";
            return b.buffer.push("\n                    <img "), b.buffer.push(A(c["bind-attr"].call(a, {
                hash: {
                    src: "navImageActive"
                },
                hashTypes: {
                ...
                types: [],
                data: b
            }))), b.buffer.push(" "), b.buffer.push(A(c["bind-attr"].call(a, {
                hash: {
                    alt: "title"
                },
                hashTypes: {
        ...
        function i(a, b) {
            ...
            return b.buffer.push("\n                    <img "), b.buffer.push(A(c["bind-attr"].call(a, {
                ...
                types: [],
                data: b
            }))), b.buffer.push(' class="rollover" '), b.buffer.push(A(c["bind-attr"].call(a, {
                hash: {
                    "data-default": "navImage"
                },
                hashTypes: {
                    "data-default": "ID"
                },
        ...
        function l(a, b) {
            b.buffer.push("Workplace Rehabilitation")
        }

        function m(a, b) {
            b.buffer.push("Disability Employment Services")
        }

        function n(a, b) {
            b.buffer.push("National Panel of Assessors")
        }

        function o(a, b) {
            b.buffer.push("Occupational Therapy ")
        }

        function p(a, b) {
            b.buffer.push("About Us")
        }
        ...
        function r(a, b) {
            b.buffer.push("Useful Links")
        }

        function s(a, b) {
            b.buffer.push("Site Map")
        }

        function t(a, b) {
            b.buffer.push("Copyright")
        }

        function u(a, b) {
            b.buffer.push("Privacy")
        }

        function v(a, b) {
            b.buffer.push("Disclaimer")
        }
        ...
        return e.buffer.push('<div id="pagewrapper">\n  <div id="page">\n    <div id="header">\n      <div id="branding">\n        <a href="#"><img src="images/generic/branding.png" width="81" height="110" alt="Branding" /></a>\n      </div><!-- end branding -->\n      <img src="images/generic/brandingslogan.png" width="752" height="24" alt="Brandingslogan" class="brandingslogan" />\n    </div>\n    <div id="content" class="clearfix">\n\n      '), w = c._triageMustache.call(b, "outlet", {
            ...
            types: ["ID"],
            data: e
        }), (w || 0 === w) && e.buffer.push(w), e.buffer.push('\n\n      <div id="nav">\n        <div class="wrapper">\n          <h2 class="accessibility">Navigation</h2>\n          <ul class="clearfix">\n            '), w = c.each.call(b, "rootNav", {
            hash: {
                itemController: "listedPage"
            },
            hashTypes: {
            ...
            types: ["ID"],
            data: e
        }), (w || 0 === w) && e.buffer.push(w), e.buffer.push("\n          </ul>\n        </div>\n        <hr />\n      </div><!-- end nav -->\n\n    </div><!-- end content -->\n\n    "), e.buffer.push(A(c.log.call(b, "isHomepage", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            contexts: [b],
            types: ["ID"],
            data: e
        }))), e.buffer.push("\n    "), w = c["if"].call(b, "isHomepage", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.program(9, k, e),
            fn: B.program(7, j, e),
            contexts: [b],
            types: ["ID"],
            data: e
        }), (w || 0 === w) && e.buffer.push(w), e.buffer.push("\n\n      <ul>\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "workplace-rehabilitation", y) : C.call(b, "link-to", "page", "workplace-rehabilitation", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push("</li>\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "disability-employment-services", y) : C.call(b, "link-to", "page", "disability-employment-services", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push("</li>\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "national-panel-of-assessors", y) : C.call(b, "link-to", "page", "national-panel-of-assessors", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push("</li>\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "occupational-therapy", y) : C.call(b, "link-to", "page", "occupational-therapy", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push("</li>\n      </ul>\n      <br>\n\n      <ul>\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "about-us", y) : C.call(b, "link-to", "page", "about-us", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push("</li>\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "contact", y) : C.call(b, "link-to", "page", "contact", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push("</li>\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "links", y) : C.call(b, "link-to", "page", "links", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push("</li>\n\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "sitemap", y) : C.call(b, "link-to", "page", "sitemap", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push("</li>\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "copyright", y) : C.call(b, "link-to", "page", "copyright", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push("</li>\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "privacy", y) : C.call(b, "link-to", "page", "privacy", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push("</li>\n        <li>"), x = c["link-to"] || b && b["link-to"], y = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: B.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, w = x ? x.call(b, "page", "disclaimer", y) : C.call(b, "link-to", "page", "disclaimer", y), (w || 0 === w) && e.buffer.push(w), e.buffer.push('</li>\n      </ul>\n\n    </div><!-- end footer -->\n\n  </div><!-- end page -->\n</div>\n<div id="extra1">&nbsp;</div>\n<div id="extra2">&nbsp;</div>\n'), z
    })
}), define("appkit/templates/careers", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('            <div id="main">\n  <img src="images/banners/careers.jpg" width="522" height="142" alt="Careers" class="banner" />\n     <h1>Careers</h1>\n<h2>Working At PPC</h2>\n\n  <p>At PPC we believe people are our most valuable asset. PPC strives to place itself as the employer of choice within the vocational rehabilitation industry.  </p>\n\n    <p>The company offers a challenging and rewarding career and seeks to attract and retain the best employees in our industry. We also aim to provide a workplace that allows everyone to perform at his or her best.</p>\n\n  <p class="listpara">The qualities we value in our employees include:</p>\n<ul>\n  <li>Professionalism</li>\n  <li>A focus on achieving outcomes for all clients</li>\n  <li>Self-motivation, integrity and respect</li>\n  <li>The ability to work independently and in a team</li>\n</ul>\n  <p class="listpara">We employ professionals with qualifications in the following fields:</p>\n<ul>\n  <li>Vocational Rehabilitation</li>\n  <li>Psychology</li>\n  <li>Social Work</li>\n  <li>Nursing</li>\n  <li>Human Resources</li>\n  <li>Occupational Therapy</li>\n  <li>Physiotherapy</li>\n</ul>\n  <h2>Benefits</h2>\n\n  <p class="listpara">Some of the benefits of working at PPC include the following:</p>\n<ul>\n  <li>Opportunities for professional development (i.e. study, support for conferences, long term career planning)</li>\n    <li>In-house induction, training, mentoring and support</li>\n    <li>Receiving regular feedback on performance</li>\n    <li>Flexible working arrangements that balance work and family / personal life</li>\n</ul>\n  <p>All PPC offices are modern comfortable and smoke free.</p>\n\n  <h2>Graduate Employment</h2>\n\n  <p>In addition to the recruitment of experienced professionals, we also recruit suitably qualified graduates. Minimum qualifications apply, for more information email <a href="mailto:careers@ppcons.com.au">careers@ppcons.com.au</a>.</p>\n\n  <h2>Submit An Application</h2>\n\n  <p>If you are interested in applying for work at PPC, you can forward your resume via our website to  HYPERLINK <a href="mailto:careers@ppcons.com.au">careers@ppcons.com.au</a>. Any information you forward to us is compliant with our Privacy Policy and the Privacy Act, 1988.</p>\n\n    <p>PPC is an Equal Opportunity Employer.</p>\n  <p>  </p>\n\n\n                <hr />\n            </div><!-- end main -->')
    })
}), define("appkit/templates/components/pretty-color", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {};
        var f, g = "";
        return e.buffer.push("Pretty Color: "), f = c._triageMustache.call(b, "name", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            contexts: [b],
...
}), define("appkit/templates/components/sidebar-nav", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            var d, e = "";
            return b.buffer.push("\n  "), d = c["if"].call(a, "child.children", {
                hash: {},
                hashTypes: {},
                hashContexts: {},
                inverse: p.program(8, k, b),
                fn: p.program(2, g, b),
                contexts: [a],
                types: ["ID"],
                data: b
        ...
        function g(a, b) {
            ...
            return b.buffer.push('\n    <li class="subheader">\n      '), d = c["if"].call(a, "child.slug", {
                ...
                types: ["ID"],
                data: b
            }), (d || 0 === d) && b.buffer.push(d), b.buffer.push("\n      <ul>\n        "), b.buffer.push(r((e = c["sidebar-nav"] || a && a["sidebar-nav"], f = {
                hash: {
                    link: "link",
                ...
                types: [],
                data: b
            }, e ? e.call(a, f) : q.call(a, "sidebar-nav", f)))), b.buffer.push("\n      </ul>\n    </li>\n  "), g
        }
        ...
        function h(a, b) {
            ...
            return b.buffer.push("\n        "), e = c["link-to"] || a && a["link-to"], f = {
                ...
                types: ["ID", "ID"],
                data: b
            }, d = e ? e.call(a, "link", "child.slug", f) : q.call(a, "link-to", "link", "child.slug", f), (d || 0 === d) && b.buffer.push(d), b.buffer.push("\n      "), g
        }

        function i(a, b) {
            var d;
            d = c._triageMustache.call(a, "child.title", {
                hash: {},
                hashTypes: {},
                hashContexts: {},
                contexts: [a],
        ...
        function j(a, b) {
            ...
            return b.buffer.push("\n        "), e = c["link-to"] || a && a["link-to"], f = {
                ...
                types: ["ID", "ID"],
                data: b
            }, d = e ? e.call(a, "link", "child", f) : q.call(a, "link-to", "link", "child", f), (d || 0 === d) && b.buffer.push(d), b.buffer.push("\n      "), g
        }
        ...
        return n = c.each.call(b, "child", "in", "children", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: p.noop,
...
}), define("appkit/templates/contact-thanks", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/contact", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('           <div id="main">\n  <img src="images/banners/contactus.jpg" width="522" height="142" alt="Contactus" class="banner" />\n           \n    <h1>Contact Us</h1>\n\n    <h2>Head Office – Adelaide CBD</h2><p>3.4km from Centrelink Norwood and a short walk from Rundle Mall</p><br/><p>Level 2, 70 Hindmarsh Square</p><p>ADELAIDE  SA  5000</p><br/><p><strong>Telephone:</strong> 1800 768 544</p><p><strong>Email:</strong> <a href="mailto:contactus@ppcons.com.au">contactus@ppcons.com.au</a></p><p><strong>Postal address:</strong> PO BOX 310, FULLARTON SA 5063</p> <iframe height="720" allowTransparency="true" frameborder="0" scrolling="no" style="width:90%;border:none" src="http://katalyst.wufoo.com/embed/contact-us/" title="HTML Form"><a href="http://katalyst.wufoo.com/embed/contact-us/" title="HTML form">Fill out my Wufoo form!</a></iframe>\n\n\n                <hr />\n            </div><!-- end main -->')
    })
}), define("appkit/templates/contact/referrals", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
    ...
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        ...
        return e.buffer.push('            <div id="main">\n    <img src="images/banners/referral2.jpg" width="522" height="142" alt="Referral2" class="banner" />\n          <h1>Copyright</h1>\n\n    <p>The information provided on this website is designed to provide general information only about Personnel Placement Consultancies Pty Ltd and the services we provide. </p>\n\n    <p>All information and other content on this web site are protected by copyright.</p>\n\n    <p>Please '), h = c["link-to"] || b && b["link-to"], i = {
            ...
            types: ["STRING", "STRING"],
            data: e
        }, g = h ? h.call(b, "page", "contact", i) : l.call(b, "link-to", "page", "contact", i), (g || 0 === g) && e.buffer.push(g), e.buffer.push(" if you have any questions regarding the copyright of information and content on this website.</p>\n                <hr />\n            </div><!-- end main -->"), j
    })
}), define("appkit/templates/disability-employment-services", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("click here")
        }
        ...
        return e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n            \n    <h1>Disability Employment Services </h1>\n\n    <p>PPC is a contracted provider to the Commonwealth Department of Social Services for the Disability Employment Services program - DES.</p>\n    <p>DES provides specialist help for people with disability, illness or injury to find and keep a job.  </p>\n    <p>The DES <em>Disability Management Service</em> (DMS) supports people with temporary disability who only need short term support in the workplace.</p>\n    <p>The DES <em>Employment Support Service</em> (ESS) is for people with a permanent disability who need longer term, regular, ongoing support to find and keep work.</p>\n    <p>PPC provides services for DMS job seekers only, and for all types of disabilities.  We can assist whether your support needs are short or long term, straight forward or complex, including where support needs might change.  We can also help people already in employment, where their disability is putting their job at risk.  </p>\n    <p>PPC supports job seekers to find lasting jobs that work for them, regardless of their disability.  </p>\n    <p>People can be referred to PPC through a Centrelink Employment Services Assessment or Job Capacity Assessment.  People are also very welcome to register directly with PPC. </p>\n    <p><em>For more information on how the DES program can help you as a job seeker or an employee, please '), i = c["link-to"] || b && b["link-to"], j = {
            ...
            types: ["STRING", "STRING"],
            data: e
        }, h = i ? i.call(b, "page", "employers", j) : m.call(b, "link-to", "page", "employers", j), (h || 0 === h) && e.buffer.push(h), e.buffer.push("</em></p>\n\n    <hr />\n</div><!-- end main -->"), k
    })
}), define("appkit/templates/disability-employment-services/des-how-can-we-help-you", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("employer wage subsidies")
        }
        ...
        return e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n            \n    <h1>How Can We Help You?</h1>\n\n    <p>At PPC we pride ourselves in empowering our clients through their job seeking.  We help job seekers identify what they can do, regardless of disability, and what they have to offer employers.  We help build skills and confidence for job seeking and for work.  We provide information and help with decision-making, so job seekers can make their own choices about work.  We take time to match job seekers with the ‘right’ job and the ‘right’ employer, to meet everyone’s needs.  PPC understands the benefits for everyone of being in the right job – stability, improved finances, social connectedness, independence and feeling good about yourself</p>\n\n    <p>We believe that everybody who is able should have the chance to benefit from the dignity of work, no matter what their circumstances. We work with a variety of individuals who are:</p>\n\n    <ul>\n      <li>Mature age</li>\n      <li>Of Aboriginal & Torres Strait Islander descent</li>\n      <li>From culturally and linguistically diverse backgrounds</li>\n      <li>Parents, including single parents</li>\n      <li>Youth, including both early and eligible school leavers</li>\n      <li>Short-term or long-term unemployed</li>\n      <li>Qualified or un-qualified workers</li>\n      <li>Experienced workers or individuals new to the workforce</li>\n      <li>Currently employed or at risk of losing their employment due to their medical circumstances</li>\n    </ul>\n\n    <p>As a job seeker accessing PPC’s services, you can expect to: </p>\n\n    <ul>\n      <li>Receive a thorough assessment of your needs</li>\n      <li>Be given information to understand the program and opportunity clarify your expectations</li>\n      <li>Feel welcomed, safe and comfortable raising concerns with your consultant</li>\n      <li>Spend the time you need with your consultant, deciding on suitable job goals</li>\n      <li>Develop a step-by-step plan to help you reach your employment goals</li>\n      <li>Access training in job search skills - resume writing, job applications, interview techniques</li>\n      <li>Receive support in addressing any personal circumstances affecting your capacity to work</li>\n      <li>Work with your consultant to establish job leads, complete applications and attend interviews</li>\n      <li>Be linked with the National Disability Recruitment Coordinator where appropriate to maximize opportunities with larger employers</li>\n      <li>Receive whatever support you need to keep your employment, for at least 6 months</li>\n      <li>Receive ongoing support beyond 6 months where this will help you maintain your employment</li>\n      <li>Have access to Government resources to help reduce barriers you might face in the workplace, for example  workplace modifications, workplace training or '), i = c["link-to"] || b && b["link-to"], j = {
            ...
            types: ["STRING", "STRING"],
            data: e
        }, h = i ? i.call(b, "page", "wage-subsidies", j) : m.call(b, "link-to", "page", "wage-subsidies", j), (h || 0 === h) && e.buffer.push(h), e.buffer.push("</li>\n      <li>Have the support of your consultant in liaising with your employer and helping manage any challenges in the workplace</li>\n    </ul>\n\n    <p>For further information or to speak to one of our staff, please "), i = c["link-to"] || b && b["link-to"], j = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: l.noop,
...
}), define("appkit/templates/disability-employment-services/employers/how-do-i-get-involved", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("contact us")
        }
        ...
        var g, h, i, j = "",
            k = this,
            l = c.helperMissing;
        return e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n          \n  <h1>How do I get involved?</h1>\n\n  <p>If you have a vacancy, have an employee with disability needing support, or would like to get involved with PPC, please '), h = c["link-to"] || b && b["link-to"], i = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: k.noop,
    ...
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        ...
        return e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n\n  <h1>What we offer:</h1>\n\n  <p>PPC Consultants:</p>\n\n  <ul>\n    <li>Listen to employers regarding their specific training and staffing requirements </li>\n    <li>Pre-screen job seekers to ensure a good organisational fit</li>\n    <li>Provide advice, support and training to co-workers regarding a new employee’s disability</li>\n    <li>Keep abreast of trends in local labour markets, including skills shortages</li>\n    <li>Set up paid or unpaid work experience (insurance provided)</li>\n    <li>Assist with training of new employees</li>\n    <li>Mentor our job seekers in the workplace to manage changes at work and any impacts of their disability</li>\n    <li>Purchase on-the-job mentoring from employers where a co-worker can support an employee</li>\n    <li>Attend worksites as often as needed to support employment outcomes</li>\n    <li>Partner with employers to develop better ways of supporting job seekers with a disability, injury or illness</li>\n    <li>Utilise Job Access through the Employment Assistant Fund, providing employers and job seekers with workplace modifications, equipment and specialised services to minimise any impacts of disability</li>\n    <li>Reward our employers for their commitment through Commonwealth Government '), j = c["link-to"] || b && b["link-to"], k = {
            ...
            types: ["STRING", "STRING"],
            data: e
        }, i = j ? j.call(b, "page", "wage-subsidies", k) : n.call(b, "link-to", "page", "wage-subsidies", k), (i || 0 === i) && e.buffer.push(i), e.buffer.push(" </li>\n  </ul>\n\n  <p>PPC can assist where an existing employee might be having difficulty in the workplace because of a disability, through the "), j = c["link-to"] || b && b["link-to"], k = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: m.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, i = j ? j.call(b, "page", "job-in-jeopardy", k) : n.call(b, "link-to", "page", "job-in-jeopardy", k), (i || 0 === i) && e.buffer.push(i), e.buffer.push(" program. </p>\n\n  <p>We can also assist employers and employees with disability where a supported wage is appropriate, through sensitive and accurate "), j = c["link-to"] || b && b["link-to"], k = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: m.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, i = j ? j.call(b, "page", "supported-wage-system", k) : n.call(b, "link-to", "page", "supported-wage-system", k), (i || 0 === i) && e.buffer.push(i), e.buffer.push(' assessments </p>\n\n  <div class="quote">\n    <p><strong>What our job seekers say about us</strong></p>\n    <blockquote>\n      What I really like about PPC is that you guys are focussed on finding the best opportunity for the clients, and that’s why I like dealing with you.\n    </blockquote>\n  </div>\n\n</div><!-- end main -->'), l
    })
}), define("appkit/templates/disability-employment-services/job-in-jeopardy", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("contact us")
        }
        ...
        return e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n            \n  <h1>Job in Jeopardy</h1>\n\n  <p>Our Job in Jeopardy program supports people at risk of losing their job due to a disability, injury or illness. PPC provides a tailored program that can address an individual’s barriers to keeping their job.</p>\n  \n  <h2>Who is eligible?</h2>\n\n  <p>People are eligible for a Job in Jeopardy program if they are:</p>\n\n  <ul>\n    <li>Between 14 and 65 years of age</li>\n    <li>An Australian citizen or permanent resident</li>\n    <li>At risk of losing their job in the immediate future due to their disability, injury or health condition</li>\n    <li>Have been employed in their job for at least eight hours per week on average over the previous 13 weeks</li>\n  </ul>\n\n  <p>People who are receiving a Centrelink sickness allowance and who meet the above-mentioned criteria may be eligible for a Job in Jeopardy program to assist them to return to work</p>\n\n  <h2>How does it work?</h2>\n\n  <p>A Job in Jeopardy program involves an initial interview to assess the person’s capacity to carry out the required tasks of their job and their ability to sustain normal hours of employment. PPC staff can then assist to organise the following, as appropriate:</p>\n\n  <ul>\n    <li>A workplace assessment </li>\n    <li>Workplace equipment and modifications, where appropriate, in consultation with the employer</li>\n    <li>Counselling, coaching and mentoring</li>\n    <li>Mediation services</li>\n    <li>Education for other staff members, eg regarding a particular disability</li>\n    <li>Monitoring the individual’s progress and determining suitable duties until they return to their normal hours of employment or alternative hours of employment</li>\n    <li>A graduated return to work </li>\n  </ul>\n\n  <p> Support can be provided on or off site, and can be offered to the employee alone and to other members of the workplace </p>\n\n  <p>PPC will provide as needed support for 26 weeks to ensure the individual can maintain their work and is no longer at risk of losing their job. This is generally measured by the person achieving their normal responsibilities and hours of work. Support can be provided beyond 26 weeks where needed.</p>\n\n  <p>If you have or one of your employees needs our help, please '), h = c["link-to"] || b && b["link-to"], i = {
            ...
            types: ["STRING", "STRING"],
            data: e
        }, g = h ? h.call(b, "page", "contact", i) : l.call(b, "link-to", "page", "contact", i), (g || 0 === g) && e.buffer.push(g), e.buffer.push("</p>\n\n  <hr />\n</div><!-- end main -->"), j
    })
}), define("appkit/templates/disability-employment-services/job-seekers-employees", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("click here")
        }
        ...
        return e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n            \n    <h1>Job Seekers & Employees</h1>\n\n    <p>\n      Please select the options below that best describe your situation in order to display appropriate next steps\n    </p>\n\n    <div class="accordions">\n\n      <p class="accordion--question">\n        Q: Do you have a temporary or permanent injury, illness or disability that impairs your ability to work?  Are you looking for help with job seeking?\n      </p>\n      <div class="accordion--answer">\n        <p>A: PPC is contracted by the Department of Employment to provide Disability Employment Services (DES) assisting people with a disability, injury or illness to get and keep work. PPC focuses on the needs of the individual by placing you, the job seeker, as the ‘expert’ in your own program. We celebrate small wins and build on successes by following consistent principles, adapting our approach to your specific needs.</p>\n        <p>To find out more about how our program works, '), h = c["link-to"] || b && b["link-to"], i = {
            ...
            types: ["STRING", "STRING"],
            data: e
        }, g = h ? h.call(b, "page", "disability-employment-services", i) : l.call(b, "link-to", "page", "disability-employment-services", i), (g || 0 === g) && e.buffer.push(g), e.buffer.push(".</p>\n        <p>To be contacted by one of our staff for further information, or to determine your eligibility for the program, "), h = c["link-to"] || b && b["link-to"], i = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: k.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, g = h ? h.call(b, "page", "des-how-can-we-help-you", i) : l.call(b, "link-to", "page", "des-how-can-we-help-you", i), (g || 0 === g) && e.buffer.push(g), e.buffer.push(".</p>\n        <p>To be contacted by one of our staff for further information, or to determine your eligibility for the program, "), h = c["link-to"] || b && b["link-to"], i = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: k.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, g = h ? h.call(b, "page", "job-in-jeopardy", i) : l.call(b, "link-to", "page", "job-in-jeopardy", i), (g || 0 === g) && e.buffer.push(g), e.buffer.push(".</p>\n        <p>To be contacted by one of our staff for further information, or to determine your eligibility for the program, "), h = c["link-to"] || b && b["link-to"], i = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: k.noop,
...
}), define("appkit/templates/disability-employment-services/wage-subsidies", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n            \n  <h1>Wage Subsidies </h1>\n\n  <p>PPC can arrange access to the Wage Subsidy Scheme, which offers employers various subsidies and incentives to employ a job seeker with disability, who is registered with a Disability Employment Services Provider. For further information on Wage Subsidies, please <a href="https://www.employment.gov.au/wage-subsidy-scheme" target="_blank">visit the Australian Department of Employment website</a>.</p>\n\n  <hr />\n</div><!-- end main -->')
    })
}), define("appkit/templates/disclaimer", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/error", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {};
        var f, g = "";
        return e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n\n  <h1>Sorry, Something went wrong</h1>\n  <p>'), f = c._triageMustache.call(b, "message", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            contexts: [b],
            types: ["ID"],
            data: e
        }), (f || 0 === f) && e.buffer.push(f), e.buffer.push("</p>\n  <pre>\n    "), f = c._triageMustache.call(b, "stack", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            contexts: [b],
...
}), define("appkit/templates/home-page/child-page", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push("<h1>Child Page</h1>\n")
    })
}), define("appkit/templates/home-page/child-page/child-child-page", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push("<h1>Child Child Page</h1>\n")
    })
}), define("appkit/templates/index", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('<div id="main_index">\n  <img src="images/banners/index.jpg" width="752" height="318" alt="Index" />\n  <img src="images/generic/index_quote_0314.png" width="554" height="156" alt="Personnel Placement Consultancies Pty Ltd (PPC) We understand injury, illness and disability. We understand work. Maximising Human Potential in the Workplace." class="indexquote" />\n  <img src="images/generic/qualityendorsedlogo.png" width="43" height="85" alt="Qualityendorsedlogo" class="qualityendorsedlogo" />\n  <hr />\n</div><!-- end main -->')
    })
}), define("appkit/templates/links", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/loading", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push("<h1>Loading...</h1>\n")
    })
}), define("appkit/templates/national-panel-of-assessors", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n            \n    <h1>National Panel of Assessors</h1>\n\n    <p>As a member of the National Panel of Assessors, PPC has a specialised team of approved Assessors conducting Supported Wage System and Ongoing Support Assessments on behalf of the Department of Social Services. PPC provides both Supported Wage System and Ongoing Support Assessment services across the entire state of South Australia, including all metropolitan and regional areas.  We also provide SWS and OSA assessments in the Employment Service Area of ACT/Queanbeyan.</p>\n\n    <hr />\n</div><!-- end main -->')
    })
}), define("appkit/templates/national-panel-of-assessors/ongoing-support-assessments", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("contact us")
        }
        ...
        var g, h, i, j = "",
            k = this,
            l = c.helperMissing;
        return e.buffer.push('<div id="main">\n  <img src="images/banners/services.jpg" width="522" height="142" alt="Services" class="banner" />\n  \n  <h1>Ongoing Support Assessments</h1>\n\n  <p>Ongoing Support Assessments (OSA) were introduced by the Department of Education, Employment and Workplace Relations in 2010, as a feature of the Disability Employment Services.  OSAs are independent assessments of the ongoing support needs of Participants with disability, where extended support is required for them to successfully maintain their employment. </p>\n\n  <p>PPC’s Ongoing Support Assessors:</p>\n\n  <ul>\n    <li>Arrange interviews at times and locations convenient for everyone involved.</li>\n    <li>Take on board the views of Participants, Employers and DES Providers about the Participant’s support needs, as well as considering important medical and other relevant information made available to the assessor .</li>\n    <li>Respect the wishes of Participants if they do not want their Employer involved in the OSA.</li>\n    <li>Are sensitive and flexible in conducting interviews where Participants might be anxious or require special arrangement due to their disability.</li>\n    <li>Welcome the involvement of the Participant’s advocate or other parties where appropriate.</li>\n    <li>Wherever agreed, attend the Participant’s worksite to get a firsthand understanding of their job.</li>\n    <li>Apply their considerable expertise in the fields of working with disability in their assessment and recommendations.  </li>\n    <li>Discuss their recommendations with parties before finalising support levels.</li>\n    <li>Liaise closely with the Department of Social Services to ensure OSAs are well managed. </li>\n  </ul>\n\n  <p>PPC’s OSA Assessors are all highly experienced in the fields of disability and employment.  We go above and beyond to ensure assessments are conducted with sensitivity and provide value to all parties.</p>\n\n  <p>For more information about Ongoing Support Assessments <a href="http://employment.gov.au/" target="_blank">click here</a>.  To enquire about PPC’s Ongoing Support Assessments, please '), h = c["link-to"] || b && b["link-to"], i = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: k.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, g = h ? h.call(b, "page", "contact", i) : l.call(b, "link-to", "page", "contact", i), (g || 0 === g) && e.buffer.push(g), e.buffer.push(". Our services are available in South Australia and the ACT.</p>\n\n\n  <hr />\n</div><!-- end main -->"), j
    })
}), define("appkit/templates/national-panel-of-assessors/supported-wage-system", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("contact us")
        }
        ...
        var g, h, i, j = "",
            k = this,
            l = c.helperMissing;
        return e.buffer.push('<div id="main">\n  <img src="images/banners/services.jpg" width="522" height="142" alt="Services" class="banner" />\n  \n  <h1>Supported Wage System</h1>\n\n  <p>The Supported Wage System (SWS) has been in place throughout Australia since 1994 to improve employment opportunities for people with disability.  The SWS offers a reliable, productivity-based wage assessment for people who are unable to work at full work productivity because of their disability.  The SWS is managed by the Department of Social Services and is supported under the Australian Industrial Relations framework.  </p>\n  <p>Employees on a supported wage are often participants registered with a Disability Employment Services (DES) provider. However, SWS assessments are also available to people who are not registered with a DES Provider.  In this case, Employers or Employees can apply directly to the Supported Wage Management Unit, and Assessors will work with them in establishing their productivity-based wage.  </p>\n  <p>SWS assessments are repeated on an annual basis while Employees remain in their jobs.</p>\n  <p>PPC’s SWS Assessors:</p>\n\n  <ul>\n    <li>Liaise closely with Employees with a disability, Employers and DES Providers to ensure assessments are well managed, efficient and accurate, with least disruption to the workplace.</li>\n    <li>Ensure Employees are well prepared and understand what to expect from their SWS assessment, and what it will mean for their wages.</li>\n    <li>Welcome the involvement of Employees’ advocates where appropriate.</li>\n    <li>Are sensitive to Employee’s needs in relation to their disability and the SWS assessments.</li>\n    <li>Attend the workplace at an agreed, convenient time, analyse the Employee’s job, and take timings of the Employee and a comparison worker to establish accurate productivity measures.</li>\n    <li>Calculate a rate of pay which reflects the Employee’s duties, the Award or workplace agreement under which they are employed, and their assessed productivity.</li>\n    <li>Facilitate the lodgement of Wage Assessment Agreements with the Industrial Instrument.</li>\n    <li>Liaise with the Supported Wage Management Unit for proper management of assessments.</li>\n  </ul>\n\n  <p>PPC’s SWS Assessors are all highly experienced in the fields of disability and employment.  We go above and beyond to ensure assessments are conducted with sensitivity, and with accuracy for the benefit of both Employees and Employers.</p>\n\n  <p>For more information about the Supported Wage System, <a href="http://www.jobaccess.gov.au/" target="_blank">click here</a>.  To enquire about how PPC can assist you to access the SWS, please '), h = c["link-to"] || b && b["link-to"], i = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: k.noop,
...
}), define("appkit/templates/occupational-therapy", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("contact us")
        }
    ...
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        ...
        function g(a, b) {
            ...
            return b.buffer.push('\n        <li class="mainheader">\n          '), e = c["link-to"] || a && a["link-to"], f = {
                ...
                types: ["STRING", "ID"],
                data: b
            }, d = e ? e.call(a, "page", "root", f) : n.call(a, "link-to", "page", "root", f), (d || 0 === d) && b.buffer.push(d), b.buffer.push("\n        </li>\n        "), b.buffer.push(o((e = c["sidebar-nav"] || a && a["sidebar-nav"], f = {
                hash: {
                    link: "page",
                ...
                types: [],
                data: b
            }, e ? e.call(a, f) : n.call(a, "sidebar-nav", f)))), b.buffer.push("\n      "), g
        }

        function h(a, b) {
            var d;
            d = c._triageMustache.call(a, "root.title", {
                hash: {},
                hashTypes: {},
                hashContexts: {},
                contexts: [a],
        ...
        return e.buffer.push(o((j = c.partial || b && b.partial, k = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            contexts: [b],
            types: ["ID"],
            data: e
        }, j ? j.call(b, "path", k) : n.call(b, "partial", "path", k)))), e.buffer.push("\n\n"), i = c["if"].call(b, "root", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: m.noop,
...
}), define("appkit/templates/privacy", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("contact us")
        }
        ...
        return e.buffer.push('            <div id="main">\n      <img src="images/banners/referral2.jpg" width="522" height="142" alt="Referral2" class="banner" />\n             <h1>Privacy</h1>\n\n<p>Personnel Placement Consultancies Pty Ltd is committed to ensuring an individual\'s right to privacy is protected as required by the Commonwealth Privacy Act 1988 as amended.</p>\n<p>Any other disclosure of personal information will only take place where written consent has been obtained or as required by law.</p>\n<p>Personnel Placement Consultancies Pty Ltd will only record your e-mail address in the event that you send us a message by e-mail or if you make an online referral. Use of your email address will only be used for the purpose for which you have provided it and will not be used or disclosed for any other purpose, without your prior written consent.</p>\n<p>Please '), h = c["link-to"] || b && b["link-to"], i = {
            ...
            types: ["STRING", "STRING"],
            data: e
        }, g = h ? h.call(b, "page", "contact", i) : l.call(b, "link-to", "page", "contact", i), (g || 0 === g) && e.buffer.push(g), e.buffer.push(" if you have any questions regarding our handling of personal information.</p>\n\n\n      \n                <hr />\n            </div><!-- end main -->"), j
    })
}), define("appkit/templates/quality", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/services", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("Workers Compensation and Return to Work Services.")
        }
        ...
        return e.buffer.push('            <div id="main">\n    <img src="images/banners/services.jpg" width="522" height="142" alt="Services" class="banner" />\n             <h1>Services</h1>\n\n      <p>Personnel Placement Consultancies provides a range of injury, disability and vocational services to a variety of private and public organizations.</p>\n\n      <p class="listpara">For more information about these services click on the following links:</p>\n      <!-- Ewan notes: will need to link this into the sections of the site -->\n      <ul>\n        <li>'), j = c["link-to"] || b && b["link-to"], k = {
            ...
            types: ["STRING", "STRING"],
            data: e
        }, i = j ? j.call(b, "page", "workers-compensation", k) : n.call(b, "link-to", "page", "workers-compensation", k), (i || 0 === i) && e.buffer.push(i), e.buffer.push("</li>\n        <li>"), j = c["link-to"] || b && b["link-to"], k = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: m.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, i = j ? j.call(b, "page", "disability-employment-services", k) : n.call(b, "link-to", "page", "disability-employment-services", k), (i || 0 === i) && e.buffer.push(i), e.buffer.push("</li>\n        <li>"), j = c["link-to"] || b && b["link-to"], k = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: m.noop,
    ...
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        ...
        return e.buffer.push('            <div id="main">\n  <img src="images/banners/services.jpg" width="522" height="142" alt="Services" class="banner" />\n        <h1>Workers Compensation</h1>\n\n    <p>PPC has been providing workplace rehabilitation services to insurers, exempt employers and government organisations since 1997.</p>\n\n    <p class="listpara">It offers the following services:</p>\n    <ul>\n    <li>'), k = c["link-to"] || b && b["link-to"], l = {
            ...
            types: ["STRING", "STRING"],
            data: e
        }, j = k ? k.call(b, "page", "return-to-work", l) : o.call(b, "link-to", "page", "return-to-work", l), (j || 0 === j) && e.buffer.push(j), e.buffer.push(" (includes pre-injury, new employer &amp; psychiatric injuries)</li>\n    <li>"), k = c["link-to"] || b && b["link-to"], l = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: n.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, j = k ? k.call(b, "page", "intensive-job-seeking", l) : o.call(b, "link-to", "page", "intensive-job-seeking", l), (j || 0 === j) && e.buffer.push(j), e.buffer.push(" (includes employment transition)</li>\n    <li>"), k = c["link-to"] || b && b["link-to"], l = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: n.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, j = k ? k.call(b, "page", "community-restoration", l) : o.call(b, "link-to", "page", "community-restoration", l), (j || 0 === j) && e.buffer.push(j), e.buffer.push("</li>\n    <li>"), k = c["link-to"] || b && b["link-to"], l = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: n.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, j = k ? k.call(b, "page", "vocational-and-suitable-employment-assessments", l) : o.call(b, "link-to", "page", "vocational-and-suitable-employment-assessments", l), (j || 0 === j) && e.buffer.push(j), e.buffer.push("</li>\n    </ul>\n    <p>For more details on PPC&rsquo;s Workers Compensation services click on the link above or call Patrick Murphy on (08) 8330 4500. </p>\n\n\n\n                <hr />\n            </div><!-- end main -->"), m
    })
}), define("appkit/templates/services/workers-compensation/community-restoration", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
    ...
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        ...
        function g(a, b) {
            b.buffer.push("How Can We Help You?")
        }

        function h(a, b) {
            b.buffer.push("Our Customers")
        }

        function i(a, b) {
            b.buffer.push("Our Values")
        }

        function j(a, b) {
            b.buffer.push("Commitment To Quality")
        }

        function k(a, b) {
            b.buffer.push("Our People")
        }

        function l(a, b) {
            b.buffer.push("Management")
        }

        function m(a, b) {
            b.buffer.push("Our Team")
        }

        function n(a, b) {
            b.buffer.push("Workplace Rehabilitation & Injury Management")
        }

        function o(a, b) {
            b.buffer.push("Pre-Injury Employer Services: Remain at Work, Return to Work, Complex Return to Work")
        }

        function p(a, b) {
            b.buffer.push("New Employer Services")
        }

        function q(a, b) {
            b.buffer.push("Employment Transition")
        }

        function r(a, b) {
            b.buffer.push("Intensive Job Seeking Program")
        }

        function s(a, b) {
            b.buffer.push("Job Placement")
        }

        function t(a, b) {
            b.buffer.push("Job Search Training & Facilities")
        }

        function u(a, b) {
            b.buffer.push("Suitable Employment Assessments")
        }

        function v(a, b) {
            b.buffer.push("Restoration to the Community")
        }
        ...
        function x(a, b) {
            b.buffer.push("Job Seekers & Employees")
        }

        function y(a, b) {
            b.buffer.push("Employers")
        }

        function z(a, b) {
            b.buffer.push("What We Offer")
        }

        function A(a, b) {
            b.buffer.push("How Do I Get Involved?")
        }
        ...
        function F(a, b) {
            b.buffer.push("Ongoing Support Assessments")
        }
        ...
        var M, N, O, P = "",
            Q = this,
            R = c.helperMissing;
        return e.buffer.push('            <div id="main">\n    <img src="images/banners/referral2.jpg" width="522" height="142" alt="Referral2" class="banner sitemap-banner" />\n               <h1>Site Map</h1>\n\n<ul class="clearfix">\n  <li>\n    '), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "about-us", O) : R.call(b, "link-to", "page", "about-us", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n    <ul>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "how-can-we-help-you", O) : R.call(b, "link-to", "page", "how-can-we-help-you", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "our-customers", O) : R.call(b, "link-to", "page", "our-customers", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "our-values", O) : R.call(b, "link-to", "page", "our-values", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "commitment-to-quality", O) : R.call(b, "link-to", "page", "commitment-to-quality", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "our-people", O) : R.call(b, "link-to", "page", "our-people", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      <ul>\n        <li>\n          "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "management", O) : R.call(b, "link-to", "page", "management", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n        </li>\n        <li>\n          "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "our-team", O) : R.call(b, "link-to", "page", "our-team", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n        </li>\n      </ul>\n    </li>\n    </ul>\n  </li>\n  <li>\n    "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "workplace-rehabilitation", O) : R.call(b, "link-to", "page", "workplace-rehabilitation", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n    <ul>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "pre-injury-employer-services", O) : R.call(b, "link-to", "page", "pre-injury-employer-services", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "new-employer-services", O) : R.call(b, "link-to", "page", "new-employer-services", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n        <ul>\n          <li>\n            "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "employment-transition", O) : R.call(b, "link-to", "page", "employment-transition", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n          </li>\n          <li>\n            "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "intensive-job-seeking-program", O) : R.call(b, "link-to", "page", "intensive-job-seeking-program", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n          </li>\n          <li>\n            "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "job-placement", O) : R.call(b, "link-to", "page", "job-placement", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n          </li>\n        </ul>\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "ppc-works", O) : R.call(b, "link-to", "page", "ppc-works", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "suitable-employment-assessments", O) : R.call(b, "link-to", "page", "suitable-employment-assessments", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "restoration-to-the-community", O) : R.call(b, "link-to", "page", "restoration-to-the-community", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n  </ul>\n  <li>\n    "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "disability-employment-services", O) : R.call(b, "link-to", "page", "disability-employment-services", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n    <ul>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "des-how-can-we-help-you", O) : R.call(b, "link-to", "page", "des-how-can-we-help-you", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "job-seekers-employees", O) : R.call(b, "link-to", "page", "job-seekers-employees", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "employers", O) : R.call(b, "link-to", "page", "employers", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n        <ul>\n          <li>\n            "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "what-we-offer", O) : R.call(b, "link-to", "page", "what-we-offer", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n          </li>\n          <li>\n            "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "how-do-i-get-involved", O) : R.call(b, "link-to", "page", "how-do-i-get-involved", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n          </li>\n        </ul>\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "wage-subsidies", O) : R.call(b, "link-to", "page", "wage-subsidies", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "job-in-jeopardy", O) : R.call(b, "link-to", "page", "job-in-jeopardy", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "des-ppc-works", O) : R.call(b, "link-to", "page", "des-ppc-works", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n    </ul>\n  </li>\n  <li>\n    "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "national-panel-of-assessors", O) : R.call(b, "link-to", "page", "national-panel-of-assessors", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n    <ul>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "supported-wage-system", O) : R.call(b, "link-to", "page", "supported-wage-system", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n      <li>\n        "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "ongoing-support-assessments", O) : R.call(b, "link-to", "page", "ongoing-support-assessments", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n      </li>\n    </ul>\n  <li>\n    "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "occupational-therapy", O) : R.call(b, "link-to", "page", "occupational-therapy", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n  </li>\n  <li>\n    "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "contact", O) : R.call(b, "link-to", "page", "contact", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n  </li>\n  <li>\n    "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "copyright", O) : R.call(b, "link-to", "page", "copyright", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n  </li>\n  <li>\n    "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "privacy", O) : R.call(b, "link-to", "page", "privacy", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n  </li>\n  <li>\n    "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "disclaimer", O) : R.call(b, "link-to", "page", "disclaimer", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n  </li>\n  <li>\n    "), N = c["link-to"] || b && b["link-to"], O = {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: Q.noop,
            ...
            types: ["STRING", "STRING"],
            data: e
        }, M = N ? N.call(b, "page", "links", O) : R.call(b, "link-to", "page", "links", O), (M || 0 === M) && e.buffer.push(M), e.buffer.push("\n  </li>\n</ul>\n\n                <hr />\n            </div><!-- end main -->"), P
    })
}), define("appkit/templates/workplace-rehabilitation", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/workplace-rehabilitation/new-employer-services", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/workplace-rehabilitation/new-employer-services/employment-transition", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/workplace-rehabilitation/new-employer-services/fit-for-work", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/workplace-rehabilitation/new-employer-services/intensive-job-seeking-program", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, Ember.Handlebars.helpers), e = e || {}, e.buffer.push('<div id="main">\n  <img src="images/banners/ourpeople.jpg" width="522" height="142" alt="Ourpeople" class="banner" />\n            \n    <h1>Intensive Job Seeking</h1>\n\n    <p>Intensive Job Seeking is a program of support for work-injured workers who are medically and vocationally ready to commence job seeking.  Workers might still face some barriers and our Consultants work with them and their team to manage these challenges and support them into work with a new employer. Intensive Job Seeking services focus on fine-tuning job seeking skills, identifying job vacancies, and assisting with negotiating employment.  We provide support to workers and their new employers for 26 weeks after job placement to ensure job outcomes are lasting.</p>\n\n    <hr />\n</div><!-- end main -->')
    })
}), define("appkit/templates/workplace-rehabilitation/new-employer-services/job-placement", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/workplace-rehabilitation/ppc-works", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
        function f(a, b) {
            b.buffer.push("contact us")
        }
...
}), define("appkit/templates/workplace-rehabilitation/pre-injury-employer-services", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/workplace-rehabilitation/restoration-to-the-community", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
...
}), define("appkit/templates/workplace-rehabilitation/suitable-employment-assessments", ["exports"], function(a) {
    a["default"] = Ember.Handlebars.template(function(a, b, c, d, e) {
